...
public class LocationReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (loc != null) {
			...
			Intent activityIntent = new Intent(context, RunActivity.class);
			activityIntent.putExtra(RunActivity.EXTRA_RUN_ID, intent.getLongExtra(RunActivity.EXTRA_RUN_ID, -1));
